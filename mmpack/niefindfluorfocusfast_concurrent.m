function offset=niefindfluorfocusfast_concurrent(posfname,focusfolder,initz,endz,stepz,ch,dicch)
...
if dicch>0
    ...
    for n=1:size(data,1)
        ...
        copyfile(files{fidx},['dic',focusfolder,'/xy',num2str(n,'%.2u'),'c',num2str(dicch,'%.2u'),'.tif']);
    end
end
