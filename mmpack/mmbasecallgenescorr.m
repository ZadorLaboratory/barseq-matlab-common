function [id21,currsig1,currscore1,lroi1,id31]=mmbasecallgenescorr(codebookbin,rolthresh1,mapthresh,psf,bgn,intmat)
...
%guess psf using deconvblind. This version allows correction of intensity
%by intmat. intmat is a m x n matrix (n==4). The image for the nth cycle and mth
%channel is multipled by the corresponding element in intmat before
%basecalling.
