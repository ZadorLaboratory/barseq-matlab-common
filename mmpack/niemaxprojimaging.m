function niemaxprojimaging(foldername,chseq,tformch,pausetime,posinfo,tform,remotelogin,remotepath,localpath)
...
if ~exist('localpath','var')
    localpath='maxproj/';
    fprintf('maxproj in current folder.\n')
elseif localpath(end)~='/'
    localpath=[localpath,'/',foldername,'/'];
    fprintf('Created local designated maxproj folder.\n');
end
