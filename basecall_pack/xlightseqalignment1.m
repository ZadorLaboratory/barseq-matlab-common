...
%This version uses sparse-nmf to find bleedthrough and does not perform 
%median filtering (already performed in xlightsubtractseqbgn. This version 
%should only be used following xlightsubtractseqbgn3/11/2019.

function [chprofile,tforms]=xlightseqalignment1(filename)
