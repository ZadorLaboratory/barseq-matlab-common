...
%9/8/2018. This version uses FFT phase correlation for image alignment and
%C channel shift is calibrated for 10x with 2x binning
function Ultraviewseqalignment4(filename)
...
% This subfunction fixes bleed through between channels in illumina seq tiff file.
    function fixedimage=fixbleed(filename)
        ...
        imageC=imtranslate(imageC,[1.1 -0.1]);
    ...
    function alignseq(imagename,templatename)
        ...
        tform = imregcorr(imagesum,templatesum,'translation','Window',0);
