function genes=evaluaterol3d(match,ref,seqC,rol)
...
%This version takes 3d stacks and rolony for first cycle only
...
for i=1:length(ref)
    scatter(rol(genes==I(i),2),rol(genes==I(i),1),2,'filled');
