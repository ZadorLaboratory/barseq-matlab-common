function [allprimers,allpadlocks,allTm,allloc,allgenes]=batchmakepadlocks2(accnum, barcodes,giiidx,idx)
...
%padlock probes. This version allows using non-continuous numbers of GII
...
for n=1:length(accnum)
    if idx(n)
        ...
        if err~=1
            ...
            [primer,padlock,Tm,loc]=designdnapadlocks1(sequence,barcodes(giiidx(n),:));
